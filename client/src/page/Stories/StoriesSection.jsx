...
const IconHandHeart = ({ className = '' }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className} xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M19.5 8.5c.7-.7 1.5-1.6 1.5-2.7A2.73 2.73 0 0 0 16 4a2.78 2.78 0 0 0-5 1.8c0 1.2.8 2 1.5 2.8L16 12Z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
const StoriesSection = () => {
  ...
  const [stories, setStories] = useState([
    {
      id: 1,
      story: "Someone created a fake Instagram account using my photos and was messaging my friends pretending to be me. It was scary because they knew personal details. I reported it and Instagram took it down within 24 hours.",
    ...
    {
      id: 2,
      story: "I received DMs from someone claiming to be a photographer who wanted to 'help me build a portfolio.' Something felt wrong, so I checked with my parents. It turned out to be a scam. Always trust your gut!",
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.nameVisibility === 'full') {
      displayName = currentUser.fullName;
    } else if (formData.nameVisibility === 'first') {
        ...
        <div className="stories-container">
                ...
                <form onSubmit={handleSubmit} className="form-content">
                  <div className="form-grid">
                    <div className="form-column">
                      <label className="form-label">Your Story <span className="required">*</span></label>
                      <textarea
                        name="story"
                    ...
                    <div className="form-column form-column-right">
                      <label className="form-label">Name Display <span className="required">*</span></label>
                      ...
                      <div className="radio-group">
                        ...
                        <label className={`radio-option ${formData.nameVisibility === 'first' ? 'radio-selected' : ''}`}>
                          ...
                          <div className="radio-content-full">
                            ...
                            <div className="radio-subtitle">Will show as: <span className="preview-name">&quot;{currentUser.firstName}&quot;</span></div>
                          </div>
                        </label>
                        <label className={`radio-option ${formData.nameVisibility === 'full' ? 'radio-selected' : ''}`}>
                          ...
                          <div className="radio-content-full">
                            ...
                            <div className="radio-subtitle">Will show as: <span className="preview-name">&quot;{currentUser.fullName}&quot;</span></div>
                          </div>
                        </label>
                      </div>
                    </div>
          ...
          {submitted && (
            <div className="modal-overlay">
              <div className="success-modal">
                <div className="success-icon-wrapper"><IconCheck className="success-icon" /></div>
          ...
          <div>
            ...
            <h2 className="section-title">
              {showMyStories ? 'My Stories' : 'Community Stories'}
            </h2>
                    ...
                    <div key={story.id} className="story-card">
                      <div className="story-header">
                        <div className="story-author">
                          <div className="author-avatar">{story.displayName === "Anonymous" ? "?" : story.displayName.charAt(0)}</div>
                          <div>
          ...
          <div className="resources-section">
            ...
            <p className="resources-description">If you&apos;re experiencing online harassment, you don&apos;t have to handle it alone.</p>
